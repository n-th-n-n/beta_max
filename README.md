...
Here I'll list out info for the project below is the autogenerated README.md for the custom frame we used to get this going.
...
But you won't have updated styles so run either in a seperate terminal
...
Build & Deploy to S3
- Seeing issues here check your local .env file, any authentication errors should be here. Probably a time to ask a dev.
- [npm run build-push]
